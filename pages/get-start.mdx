      ...
      <tr>
        <td className="w-1/2 p-6 rounded-lg align-top">
          ...
          <ul className="list-none space-y-2">
            <li className="underline"> <Link href="./get_start/create-form"><strong>📄 Create a form</strong></Link></li>
            <li className="underline"> <Link href="./get_start/form-templates"><strong>🗂️ Form templates</strong></Link></li>
          </ul>
        </td>
        <td className="w-1/2 p-6 rounded-lg align-top">
          <h3 className="text-lg font-semibold mb-4">Customize to Your Own</h3>
          <ul className="list-none space-y-2">
            <li className="underline"> <Link href="./get_start/customize-form"><strong>🎨 Customize your form</strong></Link></li>
          </ul>
        </td>
      </tr>
