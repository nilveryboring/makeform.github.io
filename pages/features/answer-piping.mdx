...
4. Type or click <span className="text-cyan-500 font-bold bg-cyan-100 px-2 py-1 rounded">@</span> to open the variable menu.
5. Choose the earlier field from the menu. Makeform inserts it as a variable such as `{{first_name}}`.
