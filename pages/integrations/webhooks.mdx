...
<Callout type="info">
Webhooks run after a form submission is saved. They are useful for custom workflows that are not covered by a native integration.
</Callout>
...
- Review integration events or logs if delivery fails.
...
Confirm the integration is enabled and the form was submitted successfully.
